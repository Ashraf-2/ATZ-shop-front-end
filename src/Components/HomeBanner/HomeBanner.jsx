...
const HomeBanner = () => {
    return (
        <div className="md:px-10 w-full flex flex-col justify-center  md:flex-row bg-[#FFF6F6] dark:bg-slate-900 dark:text-white">
            ...
            <div className="flex-1 px-5 md:px-0 ">
                <div className="flex flex-col justify-start my-16">
                    ...
                    <button className="btn btn-neutral mth-4 w-[250px] dark:bg-[#176B87]">Get Started</button>
                </div>
            </div>
